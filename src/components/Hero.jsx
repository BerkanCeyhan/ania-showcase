  ...
  return (
    <section ref={containerRef} className="relative w-full min-h-[100dvh] lg:h-[100dvh] overflow-hidden bg-[#F6F4F1] lg:grid lg:grid-cols-2">
      ...
      <div className="relative z-20 flex flex-col justify-end lg:justify-center pt-32 pb-20 md:pb-32 lg:pt-32 lg:pb-16 px-6 md:px-12 lg:px-16 xl:px-24 bg-[#F6F4F1] h-full order-2 lg:order-1">
        <div className="max-w-lg mx-auto lg:max-w-m">
          <div className="hero-anim inline-block bg-accent/10 backdrop-blur-md border border-accent/20 px-4 py-1.5 rounded-full mb-6 self-start">
            <p className="font-mono text-[10px] md:text-xs tracking-[0.2em] uppercase text-accent font-bold">Exklusives 12-Wochen Coaching</p>
          </div>

          <h1 className="hero-anim text-[clamp(2.5rem,6vw,3.5rem)] xl:text-[3.8rem] leading-[1.05] mb-6 text-text">
            <span className="font-body font-bold block">Finde zurück in deine Mitte.</span>
            <span className="font-heading italic font-light text-accent block mt-2 text-[clamp(2.8rem,7vw,4.2rem)] xl:text-[4.8rem]">Gewicht verlieren, Gelenke schonen.</span>
          </h1>

          <p className="hero-anim font-body text-base md:text-lg text-text/70 mb-8 leading-relaxed max-w-md">
            <strong>Die sanfte 3D-Methode</strong> für Frauen ab 40, um hormonelle Umstellungen zu meistern und sich wieder so leicht wie mit 20 zu fühlen.
          </p>

          <div className="hero-anim flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-10">
            <a href="#whatsapp" className="btn-hover w-full sm:w-auto bg-accent text-white px-8 py-4 rounded-full font-bold text-center text-base shadow-xl shadow-accent/20 flex items-center justify-center gap-3">
              ...
              <span>Kostenlose Beratung starten</span>
            </a>
            <div className="flex flex-col">

              <p className="font-mono text-[10px] text-text/40 tracking-wide uppercase font-bold">Limitierte Plätze</p>
              <p className="font-body text-xs text-accent font-medium">Nur noch 15 Plätze verfügbar</p>
            </div>
          </div>
      ...
      <div className="relative h-[60vh] lg:h-full w-full z-10 lg:z-20 overflow-hidden order-1 lg:order-2">
        <img 
          src="https://images.ctfassets.net/0k812o62ndtw/3Oq3ifPH3iGZ79b3EV77Za/6e0a24129f0f20f58d200d2613526975/Yoga_with_Ania_hero.png?w=1800&q=85&fm=webp" 
          alt="Ania Yoga Coaching" 
